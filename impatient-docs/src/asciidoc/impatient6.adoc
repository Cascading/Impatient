...
using
http://docs.cascading.org/cascading/2.5/javadoc/cascading/pipe/Checkpoint.html[Checkpoint],
http://docs.cascading.org/cascading/2.5/javadoc/cascading/operation/Debug.html[Debug], and 
http://docs.cascading.org/cascading/2.5/javadoc/cascading/operation/assertion/AssertMatches.html[AssertMatches].

We’ll keep building on this example to show how to leverage
http://docs.cascading.org/cascading/2.5/javadoc/cascading/flow/local/package-summary.html[“local
mode”].
...
http://docs.cascading.org/cascading/2.5/javadoc/cascading/operation/Debug.html[Debug]
...
http://docs.cascading.org/cascading/2.5/javadoc/cascading/operation/filter/Sample.html[Sample]
...
http://docs.cascading.org/cascading/2.5/javadoc/cascading/pipe/HashJoin.html[HashJoin].
...
http://docs.cascading.org/cascading/2.5/userguide/htmlsingle/#N2148A[stream
...
http://docs.cascading.org/cascading/2.5/userguide/htmlsingle/#N214F6[failure
...
bad data, then use a
http://docs.cascading.org/cascading/2.5/userguide/html/ch11s09.html[filter
instead of a trap].
...
[source,groovy]
----
testCompile group: 'cascading', name: 'cascading-platform', version: "2.5.2", classifier: 'tests'
testCompile group: 'cascading', name: 'cascading-hadoop2-mr1', version: "2.5.2", classifier: 'tests'
testCompile group: 'cascading', name: 'cascading-core', version: "2.5.2", classifier: 'tests'

testCompile group: 'org.apache.hadoop', name: 'hadoop-mapreduce-client-core', version: "2.2.0"
testCompile group: 'org.apache.hadoop', name: 'hadoop-minicluster', version: "2.2.0"
