...
using
http://docs.cascading.org/cascading/2.1/javadoc/cascading/pipe/Checkpoint.html[Checkpoint],
http://docs.cascading.org/cascading/2.1/javadoc/cascading/operation/Debug.html[Debug], and 
http://docs.cascading.org/cascading/2.1/javadoc/cascading/operation/assertion/AssertMatches.html[AssertMatches].

We’ll keep building on this example to show how to leverage
http://docs.cascading.org/cascading/2.1/javadoc/cascading/flow/local/package-summary.html[“local
mode”].
...
http://docs.cascading.org/cascading/2.1/javadoc/cascading/operation/Debug.html[Debug]
...
http://docs.cascading.org/cascading/2.1/javadoc/cascading/operation/filter/Sample.html[Sample]
...
http://docs.cascading.org/cascading/2.1/userguide/htmlsingle/#N21317[stream
...
http://docs.cascading.org/cascading/2.1/userguide/htmlsingle/#N21383[failure
...
bad data, then use a
http://docs.cascading.org/cascading/2.0/userguide/html/ch10s09.html[filter
instead of a trap].
...
gist. The input data stays the same as in the earlier code.
...
Here’s a log file from our run of the sample app, part 6. If your run looks
terribly different, something is probably not set up correctly.

To run this same app on the Amazon AWS Elastic MapReduce service, based on
their command line interface, use the following commands. Be sure to replace
temp.cascading.org with your own S3 bucket name:
