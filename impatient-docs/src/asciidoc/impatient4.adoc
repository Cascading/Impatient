...
http://docs.cascading.org/cascading/2.5/javadoc/cascading/pipe/joiner/package-summary.html[Joiner]
...
custom
http://docs.cascading.org/cascading/2.5/javadoc/cascading/operation/filter/package-summary.html[Filter].
...
http://docs.cascading.org/cascading/2.5/javadoc/cascading/operation/regex/RegexFilter.html[RegexFilter]:
