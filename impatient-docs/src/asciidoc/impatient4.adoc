...
http://docs.cascading.org/cascading/2.2/javadoc/cascading/operation/package-summary.html[Operation]
...
http://docs.cascading.org/cascading/2.2/javadoc/cascading/pipe/joiner/package-summary.html[Joiner]
...
custom
http://docs.cascading.org/cascading/2.2/javadoc/cascading/operation/filter/package-summary.html[Filter].
...
http://docs.cascading.org/cascading/2.2/javadoc/cascading/operation/regex/RegexFilter.html[RegexFilter]:
