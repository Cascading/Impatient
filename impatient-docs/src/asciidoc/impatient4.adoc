...
example in English, words such as “the”, “of”, “and” are probably not what you
want to search, and probably not interesting for Word Count metrics. They
...
not set up correctly. Drop us a line on the cascading-user email forum.
