...
http://docs.cascading.org/cascading/2.7/javadoc/cascading-core/cascading/pipe/assembly/SumBy.html[SumBy]
and a
http://docs.cascading.org/cascading/2.7/javadoc/cascading-core/cascading/pipe/CoGroup.html[CoGroup]
to aggregate the data needed, and then how to use an
http://docs.cascading.org/cascading/2.7/javadoc/cascading-core/cascading/operation/expression/ExpressionFunction.html[ExpressionFunction]
...
http://docs.cascading.org/cascading/2.7/javadoc/cascading-core/cascading/flow/FlowDef.html[FlowDef], to include output data for our
TF-IDF weights:
