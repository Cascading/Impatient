...
http://docs.cascading.org/cascading/2.2/javadoc/cascading/pipe/Each.html[Each], to split the document
...
Next, we use a
http://docs.cascading.org/cascading/2.2/javadoc/cascading/pipe/GroupBy.html[GroupBy]
...
http://docs.cascading.org/cascading/2.2/userguide/html/[User Guide] and
http://docs.cascading.org/cascading/2.2/javadoc/[JavaDoc].
