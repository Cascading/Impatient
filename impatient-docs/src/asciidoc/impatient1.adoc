...
_Driven is free for developer use on driven.io._

To get started, http://www.driven.io/choose-trial/[download the Driven plugin]
...
reside in the Cloud (trial.driven.io)  or be self-hosted. The Driven plugin, which resides close
...
you can still see how Driven will help you visualize such an application by following the
 http://showcase.driven.io/index.html#/apps/7D93CF0A824C4612AA8D5FBF77E18BB3?view=element[link].
...
that you get a free API key at http://www.driven.io/choose-trial/. If you have registered and
finished the instructions to install the key, log in at https://trial.driven.io
