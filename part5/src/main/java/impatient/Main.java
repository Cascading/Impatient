...
import static cascading.fluid.Fluid.function;
...
public class
  ...
  main( String[] args )
    ...
    Pipe tfPipe = builder
      ...
      .countBy().groupingFields( fields( "doc_id", "token" ) ).countField( fields( "tf_count" ) ).end()
    ...
    Pipe tfidfPipe = builder
      ...
      .rhs( idfPipe ).rhsGroupFields( fields( "df_token" ) )
      .createCoGroup();
